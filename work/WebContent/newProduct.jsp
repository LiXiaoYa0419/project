...
<div class="main" style="padding-bottom: 90px;">
            ...
            <ul>
                                <li>
                                    <a href="javascript:void(0);" target="_balnk" title="">
                                        <img src="<%=path %>/imgs/a5a94231-18d5-4dbe-8826-380f62ac6f90.jpg" width="1920" height="672">
                                    </a>
                                </li>
    ...
    <div class="width1190 listTopNav">
        <p><a>首页</a> &gt; <a href="javascript:location.reload();">系列</a></p>
    ...
    <div class="productList width1190">
        ...
        <c:forEach items="${list }" var="list">
                        <a href="<%=path %>/product/newProduct?id=${list.id }">
                            <li class="napolun-product">
                                ...
                                <div class="napolun-intro-1">
                                    ...
                                    <span class="napolun-introprice">${list.productTime }</span>
            ...
            <div class="footer-midmain width1190 clearfix">
                ...
                <div class="footer-erweima fr">
                    <div class="erweimabox fl">
                        <img class="erweimaimg" src="imgs/weibo.png" alt="">
                        <span class="erweimabox-font">新浪微博</span>
                    </div>
                    <div class="erweimabox fl">
                        <img class="erweimaimg" src="imgs/weixin.jpg" alt="">
    ...
    <div class="sidenav">
        <div class="sidenav-top">
            ...
            <a class="my_weixin" href="javascrit: ;">
                ...
                <img class="mobile_pic" style="width:150px ;position: absolute;top: 170px;right: 100px;" src="./草莓系列_files/weixin.jpg">
