...
<form action="<%=path %>/admin/searchUser" onsubmit="return checkForm();">
						<input style="font-size:25;" type="text" name="searchuser" placeholder="请输入查询用户的ID" id="search"/>
               ...
               <table  border="1" cellspacing="0" cellpadding="0" id="main" style="font-size:25;">
                  ...
                  <form action="<%=path%>/admin/showAllUsers">
                    <c:forEach items="${userList}" var="u">
					<tr align="center" height="50px">
						<td width="150">${u.id}</td>
						<td width="150">${u.loginName}</td>
						<td width="150">${u.password}</td>
						<td width="150">${u.email}</td>
						<td width="150">${u.address}</td>
						<td width="150">
							<a href="<%=path %>/admin/deleteUser?id=${u.id}"><input type="button" style="font-size:25;" value="删除该用户" onclick="clickTip()"/></a>
						</td>
