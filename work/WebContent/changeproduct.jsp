...
<form action="<%=path %>/admin/changeproduct">
	<table  border="1" cellspacing="0" cellpadding="0" id="main" style="font-size:25;">
						<tr>
							<td>产品ID</td>
							<td><input disabled="true" style="font-size:25;" type="text" value="${revisedProduct.id}"></td>
						</tr>
						<tr>
							<td>产品名称</td>
							<td><input style="font-size:25;" type="text" value="${revisedProduct.name }" name="name"></td>
						</tr>
						<tr>
							<td>产品类型</td>
							<td><input style="font-size:25;" type="text" value="${revisedProduct.description }" name="description"></td>
						</tr>
						<tr>
							<td>产品价格</td>
							<td><input style="font-size:25;" type="text" value="${revisedProduct.price }" name="price"></td>
						</tr>
						
						<tr align="center">
							<td colspan="2">
								<input type="submit" value="保存修改" style="font-size:25;"/>
							</td>
						</tr>
