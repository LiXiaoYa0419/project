...
<form action="<%=path %>/addProduct" enctype="multipart/form-data" method="post" >
	<table  border="1" cellspacing="0" cellpadding="0" id="main" style="font-size:25;" >
		<tr align="center"><td colspan="2">商品添加</td></tr>
		<tr>
		<td>产品名称</td>
		<td><input style="font-size:25;" type="text" name="name"/></td>
		</tr>
		<tr>
		<td>产品描述</td>
		<td><input style="font-size:25;" type="text" name="description"/></td>
		</tr>
		<tr>
		<td>产品价格</td>
		<td><input style="font-size:25;" type="text" name="price"/></td>
		</tr>
		 
		<tr align="center">
			<td colspan="2"><input type="submit" style="font-size:25;" value="添加" onclick="addProduct()"/></td>
		</tr>
	</table>
</form>
